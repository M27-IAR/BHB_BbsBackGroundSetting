...
(function(){
    ...
    if(!localStorage.version||localStorage.version!== "3.2.5.0"){//安装后的更新检测覆盖
        FirstTime=true
        localStorage.setItem("version","3.2.5.0");localStorage.removeItem("CantSeeColor2");localStorage.removeItem("CantSeeset2");
